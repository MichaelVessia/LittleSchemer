(ns littleclj.core-test
  (:require [clojure.test :refer :all]
            [littleclj.core :refer :all]))

;;; Test file taken from https://github.com/quux00/little-schemer/blob/master/clojure/littleclj-test.clj
...
(println (str "\n" (header-str "plus")))
(assert-eq 11 (plus 11 0) "1")
(assert-eq 222 (plus 111 111) "2")
(assert-eq 22 (plus 10 12) "3")
(assert-eq 22 (plus 1 21)  "4")
(assert-eq 22 (plus 22 0)  "5")
(assert-eq 22 (plus 0 22)  "6")
(assert-eq 1  (plus 0 1)   "7")
(assert-eq 0  (plus 0 0)   "8")

(println (str "\n" (header-str "minus")))
(assert-eq 11 (minus 11 0)    "1")
(assert-eq 0  (minus 111 111) "2")
(assert-eq 1  (minus 3 2)     "3")
(assert-eq 11 (minus 13 2)    "4")
...
(println (str "\n" (header-str "multiply")))
(assert-eq 0   (multiply 11 0)  "1")
(assert-eq 0   (multiply 0 11)  "2")
(assert-eq 121 (multiply 11 11) "3")
(assert-eq 6   (multiply 3 2)   "4")
(assert-eq 39  (multiply 13 3)  "5")
(assert-eq 39  (multiply 3 13)  "6")
...
(println (str "\n" (header-str "greater")))
(assert-true  (greater 10 9)  "1")
(assert-false (greater 9 10)  "2")
(assert-true  (greater 1 0)   "3")
(assert-false (greater 0 1)   "4")
(assert-false (greater 0 0)   "5")
(assert-false (greater 34 34) "6")


(println (str "\n" (header-str "less")))
(assert-false (less 10 9)  "1")
(assert-true  (less 9 10)  "2")
(assert-false (less 1 0)   "3")
(assert-true  (less 0 1)   "4")
(assert-false (less 0 0)   "5")
(assert-false (less 34 34) "6")

(println (str "\n" (header-str "equals")))
(assert-false (equals 10 9)  "1")
(assert-false (equals 9 10)  "2")
(assert-false (equals 1 0)   "3")
(assert-false (equals 0 1)   "4")
(assert-true  (equals 0 0)   "5")
(assert-true  (equals 34 34) "6")
